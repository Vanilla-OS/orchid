...
var manTemplate = `.\" Generated by Vanilla OS Orchid
.\"
.TH "{{.Name}}" "1" "" "{{.Name}} {{.Version}}" "User Manual"
.hy
.SS NAME
.IP
.nf
\f[C]
{{.Name}} - {{.RootCommand.Long}}
\f[R]
.fi
.SS SYNOPSIS
.IP
...
Usage:
  {{.RootCommand.Name}} [command]

Available Commands:
.RS
{{range .RootCommand.Children}}\fB{{.Name}}\fP	{{.Short}}{{"\n"}}{{end}}
.RE
Global Flags:
